...
if ~isempty(firstIndTrim)
    ...
    DATAtrim.pairedAnglesdPrime(~any(~isnan(DATAtrim.pairedAnglesdPrime),2),:)=[];
          DATAtrim.pairedAnglesdPrime= DATAtrim.pairedAnglesdPrime(:,all(~isnan(DATAtrim.pairedAnglesdPrime)));
