function varargout=sigstar(groups,stats,nosort,veticalSeparation)

% SIGSTAR Add significance stars to bar charts, boxplots, sline charts, etc,
%
...
y=ylim;
yd=myRange(y)*veticalSeparation; %separate sig bars vertically by 5% 
