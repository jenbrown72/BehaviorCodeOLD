function [DATA] = JB_plotSegments(basicPropertiesToPlot,plotON)
...
for h = 1:length(numPoints)
    if (indSeg(h,1)==1)
        ...
        DATA.basicPropertiesToPlot{h,1}.namedata.segmentPerformance = basicPropertiesToPlot{h,1}.segmentPerformance;
            DATA.basicPropertiesToPlot{h,1}.namedata.segmentDprime = basicPropertiesToPlot{h,1}.segmentdPrime;
            DATA.namedata{tally} = basicPropertiesToPlot{h,1}.namedata;
            DATA.mouseID = basicPropertiesToPlot{h,1}.mouseID;
            tally = tally+1;
